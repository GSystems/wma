...
public class GristTicketLoader implements ApplicationListener<ContextRefreshedEvent> {
	...
	public void onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent) {
		GristTicketModel gristTicket0 = new GristTicketModel();
		...
		gristTicketService.saveGristTicket(GristTicketMapper.toGristTicketFromModel(gristTicket0));

		log.info("Saved GristTicket - id: " + gristTicket0.getTicketId());

		GristTicketModel gristTicket1 = new GristTicketModel();
		...
		gristTicketService.saveGristTicket(GristTicketMapper.toGristTicketFromModel(gristTicket1));
